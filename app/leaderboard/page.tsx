...
export default function Leaderboard() {
    ...
    async function loadLeaderboard() {
      ...
      try {
        ...
        if (!settingsSnap.empty) {
          ...
          setCurrentGW(Number(data.currentGameweek || 7));
  ...
  const averagePoints = teams.length
    ? Math.round(
        teams.reduce((sum, team) => sum + Number(team.totalPoints || 0), 0) /
          teams.length
      )
    : 0;
      ...
      >
        ...
        >
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            >
              ...
              />
              All time leaderboard · GW{currentGW}
            </div>
        ...
        >
          ...
          >
            ...
            <div style={{ minWidth: "520px" }}>
              <div
                style={{
                  display: "grid",
                  gridTemplateColumns: "55px 1fr 120px",
                  gap: "10px",
          ...
          >
            ...
            >
              This leaderboard is ranked by{" "}
              <strong style={{ color: "var(--text)" }}>totalPoints</strong>{" "}
              from the <strong style={{ color: "var(--text)" }}>userTeams</strong>{" "}
              collection.
            </p>
